...
if __name__ == '__main__':
    sharpener = SharpenImpl()

    input = cv2.imread('in_bayer_vis.jpg')
    tree_mask = cv2.imread('tree_mask.jpg')
    human_mask = cv2.imread('human_mask.jpg')

    output = sharpener()
    cv2.imwrite('out_bayer_vis_py.jpg', output)
